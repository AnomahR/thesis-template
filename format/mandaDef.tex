...
% EIGEN
\setlength{\footskip}{30pt}		% Abstand Text - Seitennummer							
...
\if@twoside											% bei zweiseitig
	...
	\rohead{\leftmark}           % setze Abschnitt rechte Seite oben
	\cfoot{\pagemark}
...
%	\ohead{\rightmark}           	% setze rechte kopfzeile
	\cfoot[\pagemark]{\pagemark}             % seitennummer unten rechts
	%\ifoot[\Autor]{\Autor}       					% Name des Verfassers unten links
	%\renewcommand*{\chapterpagestyle}{scrheadings}		%falls auch auf Kapitelseite Kopf- und Fußzeile 
\fi
